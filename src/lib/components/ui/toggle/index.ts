...
export const toggleVariants = tv({
	...
	variants: {
		variant: {
			...
			primary:
				'bg-transparent text-muted-foreground hover:text-accent-foreground data-[state=on]:bg-transparent data-[state=on]:text-primary data-[state=on]:hover:text-primary'
		},
		size: {
			default: 'h-10 px-3',
			sm: 'h-9 px-2.5',
