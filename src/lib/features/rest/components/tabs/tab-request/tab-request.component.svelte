<script lang="ts" context="module">
	...
	import { PopoverSaveOptions } from '$lib/features/rest/components/popovers/popover-save-options';
	...
	const LAZY_TABS = [
		{
			value: 'params',
			label: 'parameters',
			content: import('$lib/features/rest/components/tabs/tab-params').then(
				(module) => module.TabParams
			),
			disabled: false
		},
		{
			value: 'body',
			label: 'body',
			content: import('$lib/features/rest/components/tabs/tab-body').then(
				(module) => module.TabBody
			),
			disabled: false
		},
		{
			value: 'headers',
			label: 'headers',
			content: import('$lib/features/rest/components/tabs/tab-headers').then(
				(module) => module.TabHeaders
			),
			disabled: false
		}
