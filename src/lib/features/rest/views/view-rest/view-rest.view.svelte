<script lang="ts" context="module">
	...
	import { SidenavREST } from '$lib/features/rest/components/sidenavs/sidenav-rest';
	import { ViewWelcome } from '$lib/features/rest/views/view-welcome';
	...
	const LAZY_VIEW_COMPONENTS = [
		import('$lib/features/rest/views/view-editor'),
		import('$lib/features/rest/views/view-response')
	] as const;

	const LAZY_DIALOG_COMPONENTS = [
		import('$lib/features/rest/components/dialogs/dialog-import'),
		import('$lib/features/rest/components/dialogs/dialog-edit-collection'),
		import('$lib/features/rest/components/dialogs/dialog-edit-request')
	] as const;
